!(function () {
  ...
  a.forEach(function (e) {
    e.addEventListener("click", function (e) {
      if (
        ...
        (t =
          t || document.querySelector("[name=" + this.hash.slice(1) + "]")) &&
          (e.preventDefault(),
  ...
  if (null != p) {
    var h = document.querySelector(".btn-scroll-top path"),
      g = h.getTotalLength();
    (h.style.transition = h.style.WebkitTransition = "none"),
      (h.style.strokeDasharray = g + " " + g),
      (h.style.strokeDashoffset = g),
      h.getBoundingClientRect(),
      (h.style.transition = h.style.WebkitTransition =
      ...
      window.addEventListener("scroll", function (e) {
        var t = document.body.scrollTop || document.documentElement.scrollTop,
          ...
          o = g - (t * g) / n;
        (h.style.strokeDashoffset = o),
          (document.body.scrollTop || document.documentElement.scrollTop) >= 50
            ? p.classList.add("active-progress")
            : p.classList.remove("active-progress");
      }),
...
if (changelogElement) {
  function changeLog() {
    changelogElement.innerHTML = "v3.2.0";
  }
  changeLog();
}
